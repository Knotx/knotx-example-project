...
|Caching APIs|Knot.x proxy all requests to target API providing such features as cache or circiut breaker. |[Fragments](https://github.com/Knotx/knotx-fragments/tree/master/handler), [WireMock](http://wiremock.org/), Docker|*coming soon*|`.api-gateway/caching-api-response`|
