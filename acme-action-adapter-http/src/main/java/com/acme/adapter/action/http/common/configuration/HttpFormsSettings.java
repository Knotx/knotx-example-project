...
public class HttpFormsSettings {
   ...
   */
  public HttpFormsSettings(
      com.acme.adapter.action.http.common.configuration.HttpFormsSettings other) {
  ...
  public com.acme.adapter.action.http.common.configuration.HttpFormsSettings setPath(String path) {
    this.path = path;
    return this;
  }
   ...
   */
  public com.acme.adapter.action.http.common.configuration.HttpFormsSettings setDomain(
      String domain) {
    this.domain = domain;
    return this;
  }
   ...
   * @return a reference to this, so the API can be used fluently
   */
  public com.acme.adapter.action.http.common.configuration.HttpFormsSettings setPort(int port) {
    this.port = port;
    return this;
  }
   ...
   * @return a reference to this, so the API can be used fluently
   */
  public com.acme.adapter.action.http.common.configuration.HttpFormsSettings setAllowedRequestHeaders(
   ...
   * @return a reference to this, so the API can be used fluently
   */
  public com.acme.adapter.action.http.common.configuration.HttpFormsSettings setQueryParams(
   ...
   * @return a reference to this, so the API can be used fluently
   */
  public com.acme.adapter.action.http.common.configuration.HttpFormsSettings setAdditionalHeaders(
  ...
  @GenIgnore
  public com.acme.adapter.action.http.common.configuration.HttpFormsSettings setAllowedRequestHeaderPatterns(
